...
// Reviews require approval before display (by provider or admin)
...
// Note: parentId references categories.id but without inline .references() to avoid circular type issue
// The relationship is defined in categoriesRelations below
