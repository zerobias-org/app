...
import type { CatalogItem, FilterType } from '../../../core/models';
...
@Component({
  ...
  styleUrl: './catalog-filter-section.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CatalogFilterSection {
  ...
  @Output() selectionChange = new EventEmitter<{ filterType: FilterType; selectedIds: Set<string> }>();
  @Output() removeSection = new EventEmitter<FilterType>();
