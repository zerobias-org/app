...
| 063 | Corporate Vetting Flow | **Done** — EngagementVettingItem GQL entity (schema v1.0.8), VettingService with CRUD + lazy seeding of 6 default items + status transitions, Vetting tab (8th engagement tab) with expansion panel checklist, add item dialog. 18 unit tests. | [`063-corporate-vetting.md`](../local/063-corporate-vetting.md) |
