...
- **Not automatable.** Stitch is a browser-based tool with no CLI or API as of
  this writing. Clark runs it manually; agents cannot invoke it.
...
- [ ] Clark to run Stitch against the prompts and drop PNGs into `mocks/`.
- [ ] UI-SPEC iteration pass after mocks are visible.
