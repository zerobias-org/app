...
| `src/app/core/services/pipeline-write.service.ts` | Class ID registration for FormSubmission | ✓ VERIFIED | FormSubmission UUID `af7eb14f-d2f0-59e3-8371-9e436b7a1bc2` registered in SME_MART_CLASS_IDS constant (line 46). |
