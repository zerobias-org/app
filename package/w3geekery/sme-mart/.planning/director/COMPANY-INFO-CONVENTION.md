...
✅ Ratified 2026-04-28 Phase 26 Plan 01. Convention approved as canonical shape for all provider + buyer profiles. No structural changes from Phase 25 draft. Schema, section names, flat-sub-section pattern, and pipeline integration all validated and locked.

---

**Status:** Ratified — Phase 26 Plan 01 approved as canonical convention document
**Created by:** Phase 25 (Platform Data Audit)
**Schema correction:** Phase 25 GQL audit + replace-semantics test (2026-04-27)
**Ratified by:** Phase 26 (Seed ZB-as-Provider) — 2026-04-28
