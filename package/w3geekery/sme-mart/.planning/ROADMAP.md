...
- 🔄 **Phase 27.5: Modernization Rule Enforcement** (INSERTED 2026-04-30, Plans 01 active) — ESLint + pre-commit hook + CI lint gate; convert prose patterns block into machine-enforced rules (est. 4-6 hrs)
