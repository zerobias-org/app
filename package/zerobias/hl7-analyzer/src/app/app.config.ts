      ...
      translate.setTranslation(
        'en',
        {
          ZbRemoteTable: {
            ...
            Apply: 'Apply',
            Cancel: 'Cancel',
            // "Starts with", not the library's default "Contains": the receiver's filter language
            // has no contains operator, so the control-id search is compiled to a prefix match.
            // Labelling it "Contains" would promise a search we cannot run.
